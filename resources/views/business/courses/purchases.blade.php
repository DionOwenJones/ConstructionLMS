                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex flex-col">
                                        <div class="text-sm text-gray-900">
                                            <span class="font-semibold">{{ $purchase->allocations->count() }}</span> of {{ $purchase->licenses_purchased }} licenses allocated
                                        </div>
                                        <div class="mt-1">
                                            <div class="w-full bg-gray-200 rounded-full h-2">
                                                <div class="bg-orange-600 h-2 rounded-full" style="width: {{ ($purchase->allocations->count() / $purchase->licenses_purchased) * 100 }}%"></div>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    @if($purchase->hasAvailableLicenses())
