...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('business.certificates')" :active="request()->routeIs('business.certificates')">
                        {{ __('Certificates') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('business.analytics')" :active="request()->routeIs('business.analytics')">
                        {{ __('Analytics') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('business.certificates')" :active="request()->routeIs('business.certificates')">
                {{ __('Certificates') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('business.analytics')" :active="request()->routeIs('business.analytics')">
                {{ __('Analytics') }}
            </x-responsive-nav-link>
        </div>
