<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 relative z-50">
    ...
    <div x-show="open"
        ...
        <div class="pt-4 pb-4 border-t border-gray-200 space-y-1">
            @if (Route::has('login'))
                <a href="{{ route('login') }}" 
                   class="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-orange-300 transition duration-150 ease-in-out">
            ...
            @if (Route::has('register'))
                <a href="{{ route('register') }}" 
                   class="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-orange-700 hover:bg-orange-50 hover:border-orange-300 transition duration-150 ease-in-out">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
